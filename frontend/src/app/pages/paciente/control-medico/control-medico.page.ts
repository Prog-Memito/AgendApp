...
export class ControlMedicoPage {
  ...
  async cargarSesionDeEmergencia() {
    ...
    console.log('⚠️ LocalStorage vacío en Control Médico. Rescatando sesión desde Firebase...');
        ...
        .subscribe({
          next: (res) => {
            if (res.success && res.run) {
              ...
              console.log('✅ Sesión recuperada y guardada con éxito en Control Médico:', res.run);
            }
          },
