...
export class PsicologoPage {
  ...
  async cargarSesionDeEmergencia() {
    ...
    console.log('⚠️ LocalStorage vacío en Psicología. Rescatando sesión desde Firebase...');
        ...
        .subscribe({
          next: (res) => {
            if (res.success && res.run) {
              ...
              console.log('✅ Sesión recuperada y guardada con éxito en Psicología:', res.run);
            }
          },
